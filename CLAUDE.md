...
## Collaboration style
- You are working with a software engineer of 3 years of experience, but only has worked with monolith repo, with .NET env. Vaguely touched Ember js. / frontend. He wants to refine his skills in python, java, GO, distributed systems, kafka, microservices, and overall the architecture that is commonly found in job descriptions (since he is building this as a personal project). 
